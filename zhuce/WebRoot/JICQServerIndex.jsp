...
<HTML>
	...
	<BODY>
		<%
			String JICQShowName = null;
			session.putValue("JShowName", JICQShowName);
		%>
		<DIV align=center>
			<LINK href="JICQServerIndex.files/account.css" type=text/css
				rel=stylesheet>
					...
					<TR>
						...
						<TD id=defaulttd width=90>
							<DIV style="PADDING-TOP: 3px; TEXT-ALIGN: center">
								<a href="JICQServerIndex.jsp">首 页</a>
							</DIV>
						</TD>
						<TD width=7>
						...
						<TD id=myAccounttd
							...
							<DIV class=main_menu_text>
								<A class=main_menu id=myAccountlnk href="loginIn.jsp">我的帐号</A>
							</DIV>
						</TD>
						<TD width=7>
							<IMG height=28 src="JICQServerIndex.files/menu_bg1.gif" width=7>
						...
						<TD id=defaulttd0 width=90>
							<DIV style="PADDING-TOP: 3px; TEXT-ALIGN: center">
								<a href="JICQFindPwdLogin.jsp"><font color="#FFFFFF">找回密码</font>
								</a>
							</DIV>
						</TD>
												...
												<TBODY>
													<TR>
														<TD width="34%">
															<DIV align=left>
																<INPUT
																	onclick="window.location.href='JICQFindPwdLogin.jsp'"

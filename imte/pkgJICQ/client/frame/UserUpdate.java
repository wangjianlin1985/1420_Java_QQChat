...
public class UserUpdate extends JFrame implements ActionListener {
	...
	JTextField jLabel4 = new JTextField(6);

	JLabel jLabel5 = new JLabel();

	JTextField jLabel6 = new JTextField(10);

	JLabel jLabel7 = new JLabel();

	JTextField jLabel10 = new JTextField(30);

	JLabel jLabel13 = new JLabel();

	JTextField jLabel16 = new JTextField(30);

	JLabel jLabel110 = new JLabel();

	XYLayout xYLayout5 = new XYLayout();

	JTextField jLabel20 = new JTextField(16);

	JTextField jLabel21 = new JTextField(16);

	JLabel jLabel111 = new JLabel();

	String[] sex = { "", "男", "女" };

	JComboBox jLabel112 = new JComboBox(sex);

	JTextField jLabel113 = new JTextField(20);
	...
	JTextField jLabel116 = new JTextField(20);
	...
	JTextField jLabel118 = new JTextField(10);
	...
	JTextField jLabel121 = new JTextField(3);

	JLabel jLabel28 = new JLabel();

	JLabel jLabel210 = new JLabel();

	JTextField jLabel211 = new JTextField(20);

	JTextField jLabel17 = new JTextField(50);

	JLabel jLabel1110 = new JLabel();

	JTextField jLabel18 = new JTextField(7);

	JLabel jLabel1111 = new JLabel();

	JTextField jLabel122 = new JTextField(30);
	...
	JTextArea jLabel9 = new JTextArea(42, 6);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == btAlter) {
			int JICQ = Integer.parseInt(jLabel25.getText().trim());
			String JShowName = jLabel21.getText().trim();
			String JTrueName = jLabel20.getText().trim();

			String JSex;
			int i = jLabel112.getSelectedIndex();
			if (i == 1) {
				JSex = "男";
			} else if (i == 2) {
				JSex = "女";
			} else {
				JOptionPane.showMessageDialog(this, "请选择性别！", "JICQ修改提示", 1);
				return;
			}
			String age = jLabel121.getText().trim();
			if (age.length() < 1) {
				JOptionPane.showMessageDialog(this, "请输入您的年龄！", "JICQ修改提示", 1);
				return;
			}

			int JAge = Integer.parseInt(jLabel121.getText().trim());
			String JCountry = jLabel118.getText().trim();
			String JProvince = jLabel113.getText().trim();
			String JCity = jLabel116.getText().trim();
			String JEmail = jLabel16.getText().trim();
			String JUnderWrite = jTextArea2.getText().trim();
			String JProfession = jLabel211.getText().trim();
			String JStar = jLabel4.getText().trim();
			String JXuexing = jLabel6.getText().trim();
			String JGradute = jLabel10.getText().trim();
			String JAddress = jLabel17.getText().trim();
			String JPostalcode = jLabel18.getText().trim();
			String JPersonalPage = jLabel122.getText().trim();
			String JPersonalInfo = jLabel9.getText().trim();

			MyDetails uu = new MyDetails();
			int k = uu.upDataUser(JICQ, JShowName, JTrueName, JAge, JSex,
					JCountry, JProvince, JCity, JEmail, JUnderWrite,
					JProfession, JStar, JXuexing, JGradute, JAddress,
					JPostalcode, JPersonalPage, JPersonalInfo);
			if (k == 1) {
				JOptionPane.showMessageDialog(this, "您的帐户信息修改成功！", "JICQ修改提示",
						1);
			} else if (k == -1) {
				JOptionPane.showMessageDialog(this, "修改失败，请确认您的操作！",
						"JICQ修改提示", 1);
			} else {
				JOptionPane.showMessageDialog(this, "年龄为不合法年龄，请确认是否正确输入！",
						"JICQ修改提示", 1);
	...
	public void setAllDetail(ResultSet rs) {
		try {
			while (rs.next()) {
				...
				String JSex = rs.getString("JSex").trim();
				if (JSex.equals("男")) {
					jLabel112.setSelectedIndex(1);
				}
				if (JSex.equals("女")) {
					jLabel112.setSelectedIndex(2);
				}
